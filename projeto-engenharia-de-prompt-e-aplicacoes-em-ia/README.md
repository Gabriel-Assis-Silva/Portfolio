...
A estrutura foi organizada em subprojetos (SM2 a SM8), cada um com objetivo técnico específico e README próprio.
...
![Bubble](https://img.shields.io/badge/Bubble-1F8DED?style=for-the-badge&logo=bubble&logoColor=white)
...
- **7 subprojetos organizados** com rastreabilidade por diretório.
...
| **SM8 - Música & IA** | Composição generativa com Gemini Gems e produção fonográfica no Suno AI. | [Ver Projeto](https://github.com/Gabriel-Assis-Silva/portfolio-gabriel-de-assis-silva/tree/main/projeto-engenharia-de-prompt-e-aplicacoes-em-ia/projeto-sm8-musica-ia) |

## 🖼️ Evidência Visual
```mermaid
flowchart LR
  A[Prompting] --> B[Prototipagem]
  B --> C[Validação]
